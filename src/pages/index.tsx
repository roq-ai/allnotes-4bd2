  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to AllNotes - Your One-Stop Solution to Collect, Record, and Organize Data, Images, Numbers, and Texts from Mobile. Simplify Your Life with our Search and Edit Functionality."
        />
      </Head>
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxkYXRhJTIwY29sbGVjdGlvbnxlbnwwfHx8fDE2OTI4NzIwMzF8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to AllNotes - Your One-Stop Solution to Collect, Record, and Organize Data, Images, Numbers, and Texts from Mobile. Simplify Your Life with our Search and Edit Functionality.`}
            </Text>
            <Box
